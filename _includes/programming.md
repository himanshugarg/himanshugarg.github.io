...
आइये, हम भी कंप्यूटर जी के साथ बातों-बातों में ऐसी ही खास संख्याएं ढूंढें।
{% case page.lang %}
	{% when "ruby" %}
कंप्यूटर जी पर `Terminal` या `Command Prompt` खोलें, `irb` टाइप करें, और फिर गणित का कोई सवाल टाईप करें।
    {% when "clojure" %}
कंप्यूटर जी पर `Terminal` या `Command Prompt` खोलें, `clojure` टाइप करें, और फिर गणित का कोई सवाल टाईप करें।
	{% when "python" %}
...
कंप्यूटर जी के साथ हम अपनी खोज और भी आसान कर सकते हैं। हम संख्याओं को नाम दे सकते हैं और फिर उन संख्याओं को याद करने के बजाय उनका नाम ले सकते हैं। यह नाम **चर** कहलाते हैं।
...
हम संख्याओं को नाम देने के साथ-साथ उन्हें बनाने के तरीके को भी नाम दे सकते हैं। और फिर कंप्यूटर जी को काम का पूरा तरीका बार-बार बताने के बजाय, बस तरीके का नाम ही ले सकते हैं। तरीकों को दिये गये नाम **फलन** कहलाते हैं।
...
* sumCubes नाम का एक फलन बनाएं जो दो संख्याओं को खुद से तीन बार गुणा करके जोड़कर बताए। {% case page.lang %}
{% when "ruby" %}
```ruby
def sumCubes(a, b)
	?
...
कोई संख्या खास है कि नहीं यह पता करने का काम अभी भी हमें ही करना पड़ रहा है। इसके बजाय हम कंप्यूटर जी को बता सकते हैं कि कैसे पता लगाएं कि कोई संख्या खास है कि नहीं। जिससे वो खुद पता लगा कर अलग-अलग स्थिति में अलग-अलग काम कर सकें।
...
* checkSumOfCubes नाम का एक फलन बनाएं जो दी गई दो संख्याओं के घनों को जोड़ कर बताए कि 1729 आता है या नहीं। {% case page.lang %}
{% when "ruby" %}
```ruby
...
* numbersUpto नाम का एक फलन बनाएं जो 1 से लेकर दी गई संख्या तक की संख्याओं की एक सूची बना कर दे। {% case page.lang %}
  {% when "ruby" %}
```ruby
...
* getListOfCubes नाम का एक फलन बनाएं जो दी गई संख्या तक की सारी संख्याओं के घनों की एक सूची बना कर दे| {% case page.lang %}
  {% when "ruby" %}
```ruby
...
* Taxicab(n) नाम का एक फलन बनाएं जो वो सबसे छोटी संख्या बताए जो n अलग-अलग तरीकों से 2 संख्याओं के घनों को जोड़कर बनती है। {% case page.lang %}
  {% when "ruby" %}
```ruby
> def Taxicab(n)
>     ?
